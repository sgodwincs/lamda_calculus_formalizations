...
def rename {Γ Δ : Context} {τ : Ty} (ρ : Rename Γ Δ) : (Γ ⊢ τ) → Δ ⊢ τ
  | .var a => Expr.var (ρ a)
  | .zero => Expr.zero
  | .succ e => Expr.succ (e.rename ρ)
  | .recursor e e₀ eₛ => Expr.recursor (e.rename ρ) (e₀.rename ρ) (eₛ.rename (Rename.ext ρ.ext))
...
theorem rename_comp_arg
  ...
  | .var _ | zero => rfl
  | .succ e => by simp only [rename, rename_comp_arg ρ ρ' e]
  | .recursor e e₀ eₛ => by
      simp only [
        rename,
        rename_comp_arg ρ ρ' e,
        rename_comp_arg ρ ρ' e₀,
        rename_comp_arg (Rename.ext ρ.ext) (Rename.ext ρ'.ext) eₛ,
        Rename.ext_comp
      ]

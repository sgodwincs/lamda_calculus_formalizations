...
def Expr.subst {Γ Γ' : Context} {τ : Ty} (σ : Subst Γ Γ') : (Γ ⊢ τ) → Γ' ⊢ τ
  ...
  | .inl e => Expr.inl (e.subst σ)
  | .inr e => Expr.inr (e.subst σ)
...
| .inl e => by simp only [Expr.rename, Expr.subst, rename_subst_subst_arg ρ e]
| .inr e => by simp only [Expr.rename, Expr.subst, rename_subst_subst_arg ρ e]
...
theorem subst_id_arg {Γ : Context} {τ : Ty} : (e : Γ ⊢ τ) → @Eq (Γ ⊢ τ) ((⟪ ids ⟫) e) e
  ...
  | .inl e => by simp only [Expr.subst, subst_id_arg e]
  | .inr e => by simp only [Expr.subst, subst_id_arg e]
  | .binary_case e eₗ eᵣ => by
      simp only [
...
theorem subst_inl
  ...
  (σ : Subst Γ Γ')
  (e : Γ ⊢ τₗ) :
  (⟪ σ ⟫) (Expr.inl e : Γ ⊢ Ty.sum τₗ τᵣ) = Expr.inl ((⟪ σ ⟫) e)
:= by
  simp only [Expr.subst]
...
theorem subst_inr
  ...
  (σ : Subst Γ Γ')
  (e : Γ ⊢ τᵣ) :
  (⟪ σ ⟫) (Expr.inr e : Γ ⊢ Ty.sum τₗ τᵣ) = Expr.inr ((⟪ σ ⟫) e)
:= by
  simp only [Expr.subst]
...
theorem subst_shift_commuteᵣ
  ...
  | _, .inl e => by simp only [Expr.rename, Expr.subst, subst_shift_commuteᵣ τs e]
  | _, .inr e => by simp only [Expr.rename, Expr.subst, subst_shift_commuteᵣ τs e]
...
theorem subst_shift_commute
  {Γ Γ' : Context} {τ τ' : Ty} {σ : Subst Γ Γ'}
  (e : Γ ⊢ τ) :
  @Eq (τ' :: Γ' ⊢ τ) ((⟪ σ.exts ⟫) e.shift) ((⟪ σ ⟫) e).shift := by
...
theorem subst_subst
  ...
  | .inl e => by simp only [Expr.subst, subst_subst σ σ' e]
  | .inr e => by simp only [Expr.subst, subst_subst σ σ' e]
  | .binary_case e eₗ eᵣ => by
      simp only [

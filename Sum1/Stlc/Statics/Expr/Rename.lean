...
def Expr.rename {Γ Γ' : Context} {τ : Ty} (ρ : Rename Γ Γ') : (Γ ⊢ τ) → Γ' ⊢ τ
  ...
  | .inl e => Expr.inl (e.rename ρ)
  | .inr e => Expr.inr (e.rename ρ)
...
theorem Expr.rename_comp_arg
  ...
  | .inl e => by simp only [Expr.rename, Expr.rename_comp_arg ρ ρ' e]
  | .inr e => by simp only [Expr.rename, Expr.rename_comp_arg ρ ρ' e]

import Prod1.Statics.Any
import Prod1.Statics.Context
import Prod1.Statics.Ty
...
theorem cast_triv
  {Γ Δ : Context} (hΓ : Γ = Δ) :
  (Expr.triv : Γ ⊢ Ty.unit).cast hΓ rfl = Expr.triv :=
by
  subst_vars
  rfl
...
@[simp]
theorem cast_pair
  {Γ Δ : Context} {τ₁ τ₁' τ₂ τ₂' : Ty} (e₁ : Γ ⊢ τ₁) (e₂ : Γ ⊢ τ₂) (hΓ : Γ = Δ) (hτ₁ : τ₁ = τ₁') (hτ₂ : τ₂ = τ₂'):
  (Expr.pair e₁ e₂ : Γ ⊢ (Ty.prod τ₁ τ₂)).cast hΓ (congr (congr rfl hτ₁) hτ₂) = Expr.pair (e₁.cast hΓ hτ₁) (e₂.cast hΓ hτ₂) :=
by
  subst_vars
  rfl
...
@[simp]
theorem cast_proj₁
  {Γ Δ : Context} {τ₁ τ₁' τ₂ : Ty} (e : Γ ⊢ Ty.prod τ₁ τ₂) (hΓ : Γ = Δ) (hτ : τ₁ = τ₁') :
  (Expr.proj₁ e : Γ ⊢ τ₁).cast hΓ hτ = Expr.proj₁ (e.cast hΓ (congr (hτ ▸ rfl) rfl)) :=
by
  subst_vars
  rfl
...
theorem cast_proj₂
  {Γ Δ : Context} {τ₁ τ₂ τ₂' : Ty} (e : Γ ⊢ Ty.prod τ₁ τ₂) (hΓ : Γ = Δ) (hτ : τ₂ = τ₂') :
  (Expr.proj₂ e : Γ ⊢ τ₂).cast hΓ hτ = Expr.proj₂ (e.cast hΓ (congr rfl hτ)) :=
by
  subst_vars
  rfl
